...
app.get('/o_foto',function(req,res){
	connection.query('select photo_src,opisanie from fotografia where (id_fotografii>=201 AND id_fotografii<=299)',function(error,result){
	var array_IMG = result;
	console.log(array_IMG.photo_src);
var store = {
	glavnaya:{
		page: 'Главная'
	},
